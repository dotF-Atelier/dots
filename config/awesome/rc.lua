...
user = {
    ...
    terminal = "sakura",
    floating_terminal = "sakura",
    browser = "chromium",
    file_manager = "thunar",
    tmux = "sakura -x tmux new",
    editor = "sakura -x nvim",
    -- editor = "emacs",
    ...
    lock_screen_password = "chenqi2013",
...
awful.rules.rules = {
    ...
    -- Media
    {
        ...
        properties = { screen = 1, floating = false, tag = awful.screen.focused().tags[8] },
        callback = function (c)
            -- awful.placement.centered(c,{honor_padding = true, honor_workarea=true})
            gears.timer.delayed_call(function()
                c.urgent = false
