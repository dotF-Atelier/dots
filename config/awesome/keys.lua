...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "d",
        function()
            awful.spawn.with_shell("sh ~/.config/rofi/scripts/apps.sh")
        end,
        {description = "rofi launcher", group = "launcher"}),

    awful.key({ superkey, shiftkey   }, "w",
        function()
            awful.spawn.with_shell("sh ~/.config/rofi/scripts/quicklinks.sh")
        end,
        {description = "rofi quicklink", group = "launcher"}),
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ superkey, shiftkey }, ".", function (c)
    ...
    awful.key({ superkey, shiftkey }, "v", function (c)
        awful.placement.centered(c, {honor_workarea = true, honor_padding = true})
        helpers.single_double_tap(
            nil,
            function ()
